...
require_once EI_PLUGIN_DIR . 'includes/helpers.php';
require_once EI_PLUGIN_DIR . 'includes/detection.php';
require_once EI_PLUGIN_DIR . 'includes/admin-bar.php';
require_once EI_PLUGIN_DIR . 'includes/settings.php';
require_once EI_PLUGIN_DIR . 'includes/dashboard-widget.php';
