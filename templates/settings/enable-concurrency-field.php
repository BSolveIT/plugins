...
<p class="description">
	<?php esc_html_e( 'Enable this option to apply the above concurrent batches setting to WordPress Action Scheduler. Only enable if you experience image processing issues. Disabled by default to avoid interference.', '365i-queue-optimizer' ); ?>
</p>